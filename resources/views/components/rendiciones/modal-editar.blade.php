    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 600px">
        <div class="modal-content shadow-md rounded-4 overflow-hidden">
            <div class="modal-header modal-header-app">
                <h6 class="modal-title fw-bold" id="modalEditarRendicionLabel">Editar rendición</h6>
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control form-control-sm shadow-sm" id="destino_editar" name="destino" 
                                        rows="2" placeholder="Descripción del destino de la rendición" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
